...
> **Status: LÖSNINGSFÖRSLAGET.** Det här är analysen och arkitekturförslaget som
> ligger till grund för prototypen. Fas 1 är nu byggd — se [README i roten](../README.md)
> för vad som faktiskt är implementerat och var koden avviker från förslaget.
> Dokumentet är skrivet för att kunna läsas av både ledning (kapitel 1–6, 22–25)
> och utvecklare (kapitel 7–21).
