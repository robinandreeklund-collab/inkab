...
| **Rita flödet** | Verktyget **Flöde** (F) och ett drag. Pilens riktning är paketens riktning: **från golvet till en maskin** är en ny inmatning som möter linjen där, **från en maskin ut på golvet** en ny väg därifrån. Ett drag är en gren, och den är markerad när du släpper — nästa maskin ur katalogen hamnar på den. Inga noder att sätta, inga namn att hitta på. Grenarna heter det formen säger: *Inmatning 1*, *Inmatning 2*, *Gemensam bana*, *Utmatning*. Två inmatningar som möts går därför att uttrycka — det gick inte när linjen var ett träd med en rot. Släpper du pilen på en bana går den ihop med banan **där** — en inport möts sällan i banans ände. Banor som byggs i sektioner (rullbana, kedjetransportör) **kapas till den sträcka du ritat**; maskiner med bestämt mått rör verktyget inte, och där mäts glappet i stället (R-701). |
